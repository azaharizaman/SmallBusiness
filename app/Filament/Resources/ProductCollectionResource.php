...
class ProductCollectionResource extends Resource
{
        ...
        return $form
            ->schema([
                Forms\Components\TextInput::make('collection_name')
                    ->required(),
                Forms\Components\TextInput::make('collection_slug')
                    ->required(),
                Forms\Components\TextInput::make('collection_description'),
            ]);
    }
        ...
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('collection_name')
                    ->searchable(),
                Tables\Columns\TextColumn::make('collection_slug')
                    ->searchable(),
                Tables\Columns\TextColumn::make('collection_description')
                    ->searchable(),
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => Pages\ViewProductCollection::route('/{record}'),
